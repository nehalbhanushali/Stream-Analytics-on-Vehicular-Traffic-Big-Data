    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Road Traffic Admin v2.0</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="#" data-toggle="modal"
								data-target="#myModal"><i class="fa fa-sign-in fa-fw"></i>Login</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Traffic Dashboard</h1>
